            ...
            {step === 1 && (
              <div className="card">
                ...
                <div className="sub">
                  ...
                  напишу тебе и предложу формат работы.
                  <br /><br />
                  Оплата — только после этого.
                  <br />
                  Сейчас это стоит <b>1990 ₽</b> — для первых <b>10</b> запросов.
                  <br /><br />
                  Деньги — не единственный путь.
                  <br />
                  Если я вижу регулярность и усилия,
                  доступ может быть открыт без оплаты.
                  <br /><br />
