            ...
            {step === 1 && (
              <div className="card">
                ...
                <div className="sub">
                  ...
                  <br />
                  Обычно такой формат стоит <b>1990 ₽</b>.
                  <br /><br />
                  Если сейчас это не откликается — это нормально.
                  <br />
                  В этом случае ты можешь продолжать путь самостоятельно.
                  <br />
                  Регулярные попытки и движение вперёд со временем
                  открывают этот формат без оплаты.
                </div>
